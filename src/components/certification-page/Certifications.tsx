...
const Certifications = () => {
    ...
    return (
            <>
                ...
                {searchComplete && certifications.length === 0 && <p className={classes.noResults}>לא נמצאו טכנאים</p>}
                <div className={classes.itemsWrapper} onScroll={handleScroll}>
                    {certifications.map(c => <ListItem key={c._id} _id={c._id} certification={c} goToCertificationPage={goToCertificationPage} />)}
                </div>
            </>
        )
}
