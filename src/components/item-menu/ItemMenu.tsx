...
const ItemMenu = () => {
    ...
    // Handlers and derived lists, outside of the .then callback
    ...
    const departmentsToChooseFrom = (rawDepartments as (string | Department)[])
        .map(d => typeof d === 'string' ? { departmentName: d } : d as { departmentName: string });
